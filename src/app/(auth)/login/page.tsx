        ...
        <div className="w-full max-w-md">
            <div className="bg-white rounded-3xl shadow-xl p-8">
                ...
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-2xl font-bold text-slate-800 mt-6">로그인</h1>
                    <p className="text-slate-500 mt-2">학습을 계속하세요</p>
                </div>
                ...
                <form onSubmit={handleEmailLogin} className="space-y-4">
                    ...
                    <div className="flex items-center justify-between text-sm">
                        ...
                        <a href="#" className="text-coral-500 hover:text-coral-600">비밀번호 찾기</a>
                    </div>
                    <button
                        type="submit"
                        disabled={loading}
                ...
                <p className="text-center text-slate-500 mt-6">
                    아직 회원이 아니신가요?{' '}
                    <Link href="/register" className="text-coral-500 font-medium hover:text-coral-600">
                        회원가입
                    </Link>
                </p>
            </div>
